...
<body>
	...
	<div class="box" id="login-box" ng-app="loginApp" ng-controller="loginController">
		...
		<section id="userinfo" class="box-content">
			...
			<fieldset>
			<input type="text" ng-model="credits.username" placeholder=<spring:message code="login.username" />></input><br />
			<input type="password" ng-model="credits.password" placeholder=<spring:message code="login.password" />></input><br />
